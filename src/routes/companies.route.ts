import { createCompany, deleteCompany, getCompanies, getCompany, updateCompany, updateCompanyAdmin } from "@/handlers/company.handler";
...
router.put("/:id/admin", authenticate, authorizeRoles("Admin"), updateCompanyAdmin);
